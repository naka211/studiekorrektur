...
<body id="page-top" class="index">
    ...
    <section class="banner" id="index">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="carousel-caption">
                  <h3>Korrekturlæsning af opgaver og afhandlinger<br> til markedets laveste priser!</h3>
        ...
        <div class="banner-fix">
            <img class="img-responsive" src="img/slider01.jpg" alt="">
            <div class="container">
                <div class="caption">
                    <h3>Korrekturlæsning af opgaver og afhandlinger<br> til markedets laveste priser!</h3>
                    <p class="mb30">- Hæv karakteren på din opgave uden at løfte en finger.</p>
    ...
    <section class="hvordan">
        <div class="container">
            <div class="row mb20">
                <img class="img-responsive hvordan-img" src="img/info.png" alt="">
            </div>
            <div class="row text-center">
                <a class="btn btnBooknow3" href="bestilling.php">Bestil nu</a>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="text-center col-sm-12 col-lg-12 mb20">
                    <hgroup>
                        ...
                        <p class="f18">Vi tilbyder korrekturlæsning på både dansk og engelsk - prisen er den samme!<br> Bemærk - minimumsbestilling på 10 sider.</p>
                    </hgroup>
                </div>
            </div>
            <div class="row mb20">
                <div class="col-sm-6 col-lg-6 mce_feature">
                    <div class="row">
                        <div class="col-sm-2 col-lg-2">
                            <i class="fa fa-desktop fa-4x mt10 f3-5"></i>
                        </div>
                ...
                <div class="col-sm-6 col-lg-6 mce_feature">
                    <div class="row">
                        <div class="col-sm-2 col-lg-2">
                            <i class="fa fa-refresh fa-4x mt10"></i>
                        </div>
            ...
            <div class="row mb20">
                <div class="col-sm-6 col-lg-6 mce_feature">
                    <div class="row">
                        <div class="col-sm-2 col-lg-2">
                            <i class="fa fa-file-text fa-4x mt10"></i>
                        </div>
                        <div class="col-sm-10 col-lg-10 pl0">
                ...
                <div class="col-sm-6 col-lg-6 mce_feature">
                    <div class="row">
                        <div class="col-sm-2 col-lg-2">
                            <i class="fa fa-search fa-4x mt10"></i>
                        </div>
                        <div class="col-sm-10 col-lg-10 pad0">
                            <h4>Kvalitet</h4>
            ...
            <div class="row">
                <div class="col-sm-6 col-lg-6 mce_feature mb0">
                    <div class="row">
                        <div class="col-sm-2 col-lg-2">
                            <i class="fa fa-repeat fa-4x mt10"></i>
                        </div>
                        <div class="col-sm-10 col-lg-10 pl0">
                            <h4>Sådan gør du</h4>
                            <p>Gennem bestillingssiden uploades opgaven som et <br>Word-dokument efter betaling. Dernæst godkender vi ordren,<br> og vores professionelle korrekturlæser læser korrektur på opgaven. Til sidst får du et Word-dokument retur, hvor du enten kan gennemgå og godkende rettelserne enkeltvis eller godkende dem alle med ét klik.</p>
                        </div>
                    </div>
                </div>
                <div class="col-sm-6 col-lg-6 mce_feature mb0">
                    <div class="row">
                        <div class="col-sm-2 col-lg-2">
                            <i class="fa fa-info-circle fa-4x mt10"></i>
                        </div>
                        <div class="col-sm-10 col-lg-10 pad0">
                            <h4>Om os</h4>
            ...
            <div class="row mb20">
                <div class="text-center col-sm-12 col-lg-12">
                    <hgroup>
                        ...
                        <p class="f20">Vi tilbyder korrekturlæsning på både dansk og engelsk - prisen er den samme! <br>Bemærk - minimumsbestilling på 10 sider.</p>
                    </hgroup>
                </div>
            </div>
            <ul class="pricing-list clearfix list-unstyled col-xs-offset-0 col-sm-offset-2">
                <li class="pricing-table text-center no">
                    <div class="pricing-title bfd6740">
                        ...
                        <span class="caret-tomato"><i class="fa fa-caret-down fa-3x"></i></span>
                    </div>
                    <div class="pricing-price">
                        <span class="price2">24</span><sup class="decimal">.95</sup>
                    </div>
                ...
                <li class="pricing-table text-center focus">
                    <div class="pricing-title">
                        ...
                        <span class="caret-green"><i class="fa fa-caret-down fa-3x"></i></span>
                    </div>
                    <div class="pricing-price"><span class="price2">29</span><sup class="decimal">.95</sup></div>
                    <ul class="pricing-features list-unstyled clearfix">
                        <li><p><strong>Korrektur på stavning og tegnsætning.<br>
                        Inkl. sproglig tilretning af<br>
                        sætningskonstruktioner.</strong></p></li>
                        <li><p>Pris kun 29,95 DKK<br>
                        pr. normalside á 2.400 tegn<br>
                        (inkl. mellemrum).</p></li>
                    </ul>
            ...
            <div class="row post">
                ...
                <div class="col-sm-2 col-lg-2">
                    <div class="text-center icon-people">
                        <img class="img-circle" src="img/men.png" alt="">
                    </div>
                </div>
                <div class="col-sm-10">
    ...
    <section class="contact">
        <div class="container">
            ...
            <div class="row pad0">
                <div class="col-md-12">
                    <form class="col-md-10 col-md-offset-2 ml8p" action="">
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <textarea class="form-control h158 input3"></textarea> 
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
                                <img class="img-responsive" src="img/capcha.jpg" alt="">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 form-group">
