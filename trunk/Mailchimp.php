...
class Mailchimp {
	...
	/**
     * Cam added 10/12/2013
     */
    public function mailchimp_subcriber($data, $mailchimp, $list_id, $send_welcome = false){
    ...
    public function mailchimp_unsubcriber($data, $mailchimp, $list_id){
