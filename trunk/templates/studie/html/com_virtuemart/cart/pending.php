						...
						<div class="panel-body">
							...
							<div class="row">
								<div class="col-md-6">
									...
									<p>File name: <?php echo $order['details']['BT']->danish_file;?> <span id="download<?php echo $order['details']['BT']->virtuemart_order_id;?>" style="display:none;"><a class="btnDownload" href="<?php echo JURI::base().'index.php?option=com_virtuemart&view=cart&task=downloadFile&original=1&fileName='.$order['details']['BT']->danish_file;?>">Download</a></span></p>
									<?php } else {?>
									<p>File name: <?php echo $order['details']['BT']->danish_file;?> <a class="btnDownload" href="<?php echo JURI::base().'index.php?option=com_virtuemart&view=cart&task=downloadFile&original=1&fileName='.$order['details']['BT']->danish_file;?>">Download</a></p>
									<?php }?>
